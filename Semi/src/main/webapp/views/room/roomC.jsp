...
#priceBottom {
    ...
    <div class="panNameEn">
        Place to stay in the fullstack
    </div>
    <hr id="hr1" />
    <div id="contents1">
        <img src="${ path }/resources/images/AdobeStock_416303838.jpeg"  style="width: 1200px; height: 500px;">
    </div>
    <hr id="hr1" />
        ...
        <div id="contents2">
            ...
            <div id="content1">
                ...
                <div class="guideBottom">
                    ...
                    <div id="BottomRight">
                        프론트가 머무는 곳 - 100,000 원 <br>
                        백엔드가 머무는 곳 - 150,000 원 <br>
                        풀스택이 머무는 곳 - 200,000 원 <br><br>
                        성인 1인당 20,000 원 <br>
                        어린이 1인당 10,000 원 <br>
