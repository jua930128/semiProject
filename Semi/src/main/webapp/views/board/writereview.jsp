    ...
    <section>
        <div class="container">
            ...
            <div id="wrap">
                ...
                <form action="${path}/board/writereview" method="POST">
                <input type="hidden" name="no" value="${ review.no }" >
                    <div id="tooltop" >
                            <textarea  id="title" cols="40" rows="1" placeholder="제목" name="title" required  ></textarea>
                            <textarea name="writer" id="writer" cols="20" rows="1" readonly>작성자 : </textarea>
                    ...
                    <div id="toolbottom" >
                        ...
                        <button type="submit" id="btnsubmit" class="right">작성하기</button>
                        
                        <select id="room_name" name ="room_name" class="right">
                            <option value="프론트가 머무는 곳" selected >프론트가 머무는 곳</option>
                            <option value="백엔드가 머무는 곳">백엔드가 머무는 곳</option>
                            <option value="풀스택이 머무는 곳">풀스택이 머무는 곳</option>
                        </select>
